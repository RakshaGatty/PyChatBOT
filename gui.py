...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        self.text_box = Text(self.text_frame, yscrollcommand=self.text_box_scrollbar.set, state=DISABLED,
                             bd=1, padx=6, pady=6, spacing3=8, wrap=WORD, bg="#CCCCFF", font="Verdana 10", relief=GROOVE,
                             width=10, height=1)
        ...
        # send button
        self.send_button = Button(self.send_button_frame, text="Send", width=5, relief=GROOVE, bg='#CCCCFF',
    ...
    def about(self):
        tkinter.messagebox.showinfo("PyBOT Developer","1.Raksha")
